...
uniquecountry <- c("China", "Norway", "Chile", "Nigeria")
...
for (i in 1:4){ #for each of the 4 countries
...
# #save this data
# NAME<- sprintf("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/prod_totals_countries.csv")
# write.csv(country_case_study_totals,file=NAME)

###SUM production totals by country for future weighting...?
country_case_study_totals <- read.csv("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/prod_totals_countries.csv")
...
#We have a list of each country to loop through: uniquecountry <- c("China", "Norway", "Chile", "Nigeria")
...
#save this data
# NAME<- sprintf("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/cat_totals_countries.csv")
...
#load in the totals
totals <- read.csv("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/cat_totals_countries.csv")
totals <- totals[, c(-1)]

cat_totals <- read.csv("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/prod_totals_countries.csv")
cat_totals <- cat_totals[, c(-1)] #need to delete first column for this one only
...
unique <- c("China", "Norway", "Chile", "Nigeria") 
...
year_labs <- rep(2021:1950, times=4, each=1)
print(year_labs)
...
#SAVE
# NAME <- sprintf("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/Fweighted_bycountry.csv")
# write.csv(weighted_indexes, file =NAME)
```
...
#SAVE
# NAME <- sprintf("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/Cweighted_bycountry.csv")
# write.csv(weighted_indexes, file =NAME)
```
...
#SAVE
# NAME <- sprintf("/Users/aleahw/Documents/Master's!!/Chapter_2/Data/Bweighted_bycountry.csv")
# write.csv(weighted_indexes, file =NAME)
```
