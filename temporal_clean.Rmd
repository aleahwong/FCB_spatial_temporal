...
#FINFISH
plot <- ggplot(finfish_merge, aes(x=Year, y=Score, color = Index)) +geom_line(size =1)+
...
#ALGAE
plot <- ggplot(algae_merge, aes(x=Year, y=Score, color = Index)) +geom_line(size =1)+
...
#MOLLUSCS
plot <- ggplot(mollusc_merge, aes(x=Year, y=Score, color = Index)) +geom_line(size =1)+
...
#CRUSTACEANS
plot <- ggplot(crust_merge, aes(x=Year, y=Score, color = Index)) +geom_line(size =1)+
